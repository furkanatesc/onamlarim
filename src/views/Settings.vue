    ...
    <div class="bg-white border border-slate-200/50 rounded-2xl p-6 shadow-xs space-y-8">
      ...
      <div class="space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div class="space-y-1">
            ...
            <input v-model="settings.clinicName" type="text" class="w-full px-3.5 py-2 text-xs border border-slate-200 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-300" />
          </div>
          <div class="space-y-1">
            <label class="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Klinik Adresi</label>
            <input v-model="settings.address" type="text" class="w-full px-3.5 py-2 text-xs border border-slate-200 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-300" />
          </div>
        </div>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div class="space-y-1">
            ...
            <select v-model="settings.appointmentDuration" class="w-full px-3.5 py-2 text-xs border border-slate-200 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-300">
          ...
          <div class="space-y-1">
            ...
            <select v-model="settings.syncInterval" class="w-full px-3.5 py-2 text-xs border border-slate-200 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-300">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="space-y-4">
          ...
          <div class="flex flex-col gap-3 text-xs text-slate-600 font-semibold">
            <label class="flex items-center gap-2.5 cursor-pointer">
              <input v-model="settings.smsReminders" type="checkbox" class="w-4 h-4 rounded text-blue-600 border-slate-200 focus:ring-blue-500/20" />
              <span>Eşitleme sonrası hastaya SMS ile bilgilendirme yap</span>
            </label>
            <label class="flex items-center gap-2.5 cursor-pointer">
              <input v-model="settings.stockAlerts" type="checkbox" class="w-4 h-4 rounded text-blue-600 border-slate-200 focus:ring-blue-500/20" />
        ...
        <div class="space-y-4">
          ...
          <div class="flex flex-col gap-3 text-xs text-slate-600 font-semibold">
            <label class="flex items-center gap-2.5 cursor-pointer">
              <input v-model="settings.eSignature" type="checkbox" class="w-4 h-4 rounded text-blue-600 border-slate-200 focus:ring-blue-500/20" />
              <span>e-İmza (e-Güven/TÜBİTAK) entegrasyonunu doğrula</span>
            </label>
            <label class="flex items-center gap-2.5 cursor-pointer">
              <input v-model="settings.eNabizSync" type="checkbox" class="w-4 h-4 rounded text-blue-600 border-slate-200 focus:ring-blue-500/20" />
...
const settings = ref({
  clinicName: 'Onamlarım Kardiyoloji ve Ağız Diş Sağlığı Merkezi',
