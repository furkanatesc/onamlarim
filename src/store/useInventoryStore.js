...
export const useInventoryStore = defineStore('inventory', () => {
  const items = ref([
    { id: 'INV-001', name: 'Dental Implant 4.5mm', category: 'Surgical', stock: 12, minStock: 15, unit: 'pcs', history: [22, 20, 19, 17, 15, 13, 12] },
    ...
    { id: 'INV-003', name: 'Composite Syringes (A2)', category: 'Restorative', stock: 5, minStock: 10, unit: 'pcs', history: [12, 11, 10, 8, 7, 6, 5] },
